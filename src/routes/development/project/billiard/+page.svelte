<script lang="ts">
	...
	import vid1 from "$lib/assets/videos/2024-09-28 17-59-21_billiard_1.mp4";
	import vid2 from "$lib/assets/videos/2024-09-28 18-02-06_billiard_2.mp4";
